...
const profileTarget = shallowRef<Npc | null>(null);

function openProfileModal() {
  profileTarget.value = props.npc ?? null;
...
function openEquipDetail(key: EquipSlotKey) {
  ...
  if (!it) return;
  itemDetailPayload.value = buildWearableDetailPayload(it, undefined, npc.realm);
