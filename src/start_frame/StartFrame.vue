        ...
        <div v-for="it in saves" :key="it.id" class="save-load-row">
          <div class="save-load-info">
            <p class="save-load-name">
              ...
              <span v-if="it.auto" class="save-load-badge save-load-badge--auto">自动 · {{ it.auto.turn }}</span>
        ...
        <div class="splash-modal splash-modal--wide" role="dialog" aria-modal="true" aria-labelledby="help-title">
          ...
          <div class="help-content">
            ...
            <section class="help-section">
              ...
              <p class="help-p">
                6 大境界：凡人 → 练气 → 筑基 → 结丹 → 元婴 → 化神；每个大境界分 初期 / 中期 / 后期，共 18 阶。
            ...
            <section class="help-section">
              ...
              <p class="help-p">
                功法有 8 个槽位。每门功法能修炼到几层由**阶层**决定——凡人武功 3 层、练气 5 层、筑基 6 层、
                结丹 7 层、元婴 8 层、化神 10 层。消耗灵石闭关修炼，每颗灵石约换 100 修炼进度经验。
              </p>
              <p class="help-p help-highlight">
                ★ 关键规则：功法修炼进度的提升会等额加到修为上 —— 修炼功法就是提升修为，是中后期成长的核心。
              </p>
              <p class="help-p">
            ...
            <section class="help-section">
              ...
              <ul class="help-list">
                ...
                <li>侧边栏「自动存档」可设置<b>滚动保留最近 N 个回合的快照</b>（默认 3，0 为关闭）；快照带「自动 · 回合数」标记，读取即可回到那个回合的起点。</li>
              </ul>
            </section>
          </div>
        </div>
